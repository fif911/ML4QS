...
basic_features = ['acc_x', 'acc_y', 'acc_z', 'lin_acc_x','lin_acc_y','lin_acc_z', 'loc_speed', 'gyr_x', 'gyr_y', 'gyr_z', 'loc_horizontal_accuracy', 'loc_vertical_accuracy', 'mang_field_x', 'mang_field_y', 'mang_field_z']
